package com.pzhang7.study.network.netty.client;
...
/**
 * @author: SYSTEM
 * @date: created on 2018/8/7 0007 18:31
 * @description: 一个SocketClientRequestThread线程模拟一个客户端请求。
 */
public class SocketClientRequestThread implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < threadCount; i++) {
            Thread t = new Thread(new SocketClientRequestThread(countDownLatch, threadCount));
            t.start();
        }
    }
